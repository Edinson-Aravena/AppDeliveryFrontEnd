...
interface Props {
    order: Order,
    navigation: StackNavigationProp<RestaurantOrderStackParamList, 'RestaurantOrderListScreen', undefined>
}

export const OrdenListItem = ({ order, navigation }: Props) => {
    return (
        <TouchableOpacity
            onPress={() => navigation.navigate('RestauranteOrderDetailScreen', { order:order })} 
        >
